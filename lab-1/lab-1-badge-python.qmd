...
Use the institutional library (e.g. [NCSU Library](https://www.lib.ncsu.edu/#articles)), [Google Scholar](https://scholar.google.com/) or search engine to locate a research article, presentation, or resource that applies text mining to an educational context or topic of interest. More specifically, **locate a study that uses LLM to code qualitative data.**

1.  Provide an APA citation for your selected study.

    -   

2.  How does LLM address research questions?
