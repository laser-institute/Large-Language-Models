---
title: "Lab 1: Assessing High School Students' Machine Learning Literacy"
...
gpt_key = "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" #use your own key
...
```{python}
#final = pd.read_csv("modified.csv")
```
